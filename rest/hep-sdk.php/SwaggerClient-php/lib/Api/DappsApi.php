...
class DappsApi
{
     ...
     */
    public function dappsRead($dapp_id, $dapp_key, $protocol, $version, $ts, $nonce, $os, $language, $md5)
    {
        list($response) = $this->dappsReadWithHttpInfo($dapp_id, $dapp_key, $protocol, $version, $ts, $nonce, $os, $language, $md5);
        return $response;
    }

    /**
     * Operation dappsReadWithHttpInfo
     *
     ...
     */
    public function dappsReadWithHttpInfo($dapp_id, $dapp_key, $protocol, $version, $ts, $nonce, $os, $language, $md5)
    {
        $returnType = '\Swagger\Client\Model\Dapp';
        $request = $this->dappsReadRequest($dapp_id, $dapp_key, $protocol, $version, $ts, $nonce, $os, $language, $md5);
     ...
     */
    public function dappsReadAsync($dapp_id, $dapp_key, $protocol, $version, $ts, $nonce, $os, $language, $md5)
    {
        return $this->dappsReadAsyncWithHttpInfo($dapp_id, $dapp_key, $protocol, $version, $ts, $nonce, $os, $language, $md5)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation dappsReadAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $dapp_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dappsReadAsyncWithHttpInfo($dapp_id, $dapp_key, $protocol, $version, $ts, $nonce, $os, $language, $md5)
    {
        $returnType = '\Swagger\Client\Model\Dapp';
        $request = $this->dappsReadRequest($dapp_id, $dapp_key, $protocol, $version, $ts, $nonce, $os, $language, $md5);
    ...
    /**
     * Create request for operation 'dappsRead'
     *
     * @param  string $dapp_id (required)
     * @param  string $dapp_key The decentralized application access key (required)
     * @param  string $protocol The protocol name. default is &#x27;HEP&#x27;. (required)
     ...
     */
    protected function dappsReadRequest($dapp_id, $dapp_key, $protocol, $version, $ts, $nonce, $os, $language, $md5)
    {
        // verify the required parameter 'dapp_id' is set
        if ($dapp_id === null || (is_array($dapp_id) && count($dapp_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $dapp_id when calling dappsRead'
            );
        }
        // verify the required parameter 'dapp_key' is set
        if ($dapp_key === null || (is_array($dapp_key) && count($dapp_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $dapp_key when calling dappsRead'
            );
        }
        // verify the required parameter 'protocol' is set
        if ($protocol === null || (is_array($protocol) && count($protocol) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $protocol when calling dappsRead'
            );
        }
        // verify the required parameter 'version' is set
        if ($version === null || (is_array($version) && count($version) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $version when calling dappsRead'
            );
        }
        // verify the required parameter 'ts' is set
        if ($ts === null || (is_array($ts) && count($ts) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ts when calling dappsRead'
            );
        }
        // verify the required parameter 'nonce' is set
        if ($nonce === null || (is_array($nonce) && count($nonce) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $nonce when calling dappsRead'
            );
        }
        // verify the required parameter 'os' is set
        if ($os === null || (is_array($os) && count($os) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $os when calling dappsRead'
            );
        }
        // verify the required parameter 'language' is set
        if ($language === null || (is_array($language) && count($language) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $language when calling dappsRead'
            );
        }
        // verify the required parameter 'md5' is set
        if ($md5 === null || (is_array($md5) && count($md5) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $md5 when calling dappsRead'
            );
        }

        $resourcePath = '/dapps/{dapp_id}/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
