...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-14T20:03:01.379+08:00[Asia/Shanghai]")public class ProofResponse {
  ...
  * @return action
  **/
  @Schema(required = true, description = "The action name which value is 'hep.proof.submit'.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(dappKey, protocol, version, ts, nonce, os, language, dappSignatureMethod, dappSignature, signType, signature, action, uuid, dappId, content);
  }
