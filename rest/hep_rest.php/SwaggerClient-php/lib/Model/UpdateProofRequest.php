...
/**
 * UpdateProofRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateProofRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateProofRequest';
...
'confirmer' => 'getConfirmer'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['confirmer'] = isset($data['confirmer']) ? $data['confirmer'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['confirmer'] === null) {
            $invalidProperties[] = "'confirmer' can't be null";
        }
    ...
    {
        return $this->container['confirmer'];
    }

    /**
     * Sets confirmer
     *
     * @param string $confirmer The confirmer's NewID
     *
     * @return $this
     */
    public function setConfirmer($confirmer)
    {
        $this->container['confirmer'] = $confirmer;
