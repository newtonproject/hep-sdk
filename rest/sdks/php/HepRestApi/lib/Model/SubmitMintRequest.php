...
/**
 * SubmitMintRequest Class Doc Comment
 *
 * @category Class
 * @package  HepRestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SubmitMintRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubmitMintRequest';
    ...
    protected static $setters = [
        ...
        'newid' => 'setNewid',
        'tx_tokens' => 'setTxTokens',
        'tx_gravity' => 'setTxGravity',
        'action' => 'setAction',
        'uuid' => 'setUuid',
        'dapp_id' => 'setDappId'
    ];
    ...
    protected static $getters = [
        ...
        'newid' => 'getNewid',
        'tx_tokens' => 'getTxTokens',
        'tx_gravity' => 'getTxGravity',
        'action' => 'getAction',
        'uuid' => 'getUuid',
        'dapp_id' => 'getDappId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tx_tokens'] = isset($data['tx_tokens']) ? $data['tx_tokens'] : null;
        $this->container['tx_gravity'] = isset($data['tx_gravity']) ? $data['tx_gravity'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tx_tokens'] === null) {
            $invalidProperties[] = "'tx_tokens' can't be null";
        }
        if ((mb_strlen($this->container['tx_tokens']) > 256)) {
            $invalidProperties[] = "invalid value for 'tx_tokens', the character length must be smaller than or equal to 256.";
        }

        if ((mb_strlen($this->container['tx_tokens']) < 1)) {
            $invalidProperties[] = "invalid value for 'tx_tokens', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['tx_gravity'] === null) {
            $invalidProperties[] = "'tx_gravity' can't be null";
        }
        if ((mb_strlen($this->container['tx_gravity']) > 256)) {
            $invalidProperties[] = "invalid value for 'tx_gravity', the character length must be smaller than or equal to 256.";
        }

        if ((mb_strlen($this->container['tx_gravity']) < 1)) {
            $invalidProperties[] = "invalid value for 'tx_gravity', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setDappKey($dapp_key)
    {
        if ((mb_strlen($dapp_key) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_key when calling SubmitMintRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_key when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setProtocol($protocol)
    {
        if ((mb_strlen($protocol) > 10)) {
            throw new \InvalidArgumentException('invalid length for $protocol when calling SubmitMintRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($protocol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $protocol when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setVersion($version)
    {
        if ((mb_strlen($version) > 10)) {
            throw new \InvalidArgumentException('invalid length for $version when calling SubmitMintRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($version) < 1)) {
            throw new \InvalidArgumentException('invalid length for $version when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setNonce($nonce)
    {
        if ((mb_strlen($nonce) > 64)) {
            throw new \InvalidArgumentException('invalid length for $nonce when calling SubmitMintRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($nonce) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nonce when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((mb_strlen($os) > 10)) {
            throw new \InvalidArgumentException('invalid length for $os when calling SubmitMintRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($os) < 1)) {
            throw new \InvalidArgumentException('invalid length for $os when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLanguage($language)
    {
        if ((mb_strlen($language) > 10)) {
            throw new \InvalidArgumentException('invalid length for $language when calling SubmitMintRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($language) < 1)) {
            throw new \InvalidArgumentException('invalid length for $language when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDappSignatureMethod($dapp_signature_method)
    {
        if ((mb_strlen($dapp_signature_method) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature_method when calling SubmitMintRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_signature_method) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature_method when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDappSignature($dapp_signature)
    {
        if ((mb_strlen($dapp_signature) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature when calling SubmitMintRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_signature) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSignType($sign_type)
    {
        if ((mb_strlen($sign_type) > 64)) {
            throw new \InvalidArgumentException('invalid length for $sign_type when calling SubmitMintRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($sign_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sign_type when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSignature($signature)
    {
        if ((mb_strlen($signature) > 130)) {
            throw new \InvalidArgumentException('invalid length for $signature when calling SubmitMintRequest., must be smaller than or equal to 130.');
        }
        if ((mb_strlen($signature) < 1)) {
            throw new \InvalidArgumentException('invalid length for $signature when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setNewid($newid)
    {
        if ((mb_strlen($newid) > 64)) {
            throw new \InvalidArgumentException('invalid length for $newid when calling SubmitMintRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($newid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $newid when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
     ...
     * @return string
     */
    public function getTxTokens()
    {
        return $this->container['tx_tokens'];
    }

    /**
     * Sets tx_tokens
     *
     * @param string $tx_tokens tx_tokens
     *
     * @return $this
     */
    public function setTxTokens($tx_tokens)
    {
        if ((mb_strlen($tx_tokens) > 256)) {
            throw new \InvalidArgumentException('invalid length for $tx_tokens when calling SubmitMintRequest., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($tx_tokens) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tx_tokens when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }

        $this->container['tx_tokens'] = $tx_tokens;
     ...
     * @return string
     */
    public function getTxGravity()
    {
        return $this->container['tx_gravity'];
    }

    /**
     * Sets tx_gravity
     *
     * @param string $tx_gravity tx_gravity
     *
     * @return $this
     */
    public function setTxGravity($tx_gravity)
    {
        if ((mb_strlen($tx_gravity) > 256)) {
            throw new \InvalidArgumentException('invalid length for $tx_gravity when calling SubmitMintRequest., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($tx_gravity) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tx_gravity when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }

        $this->container['tx_gravity'] = $tx_gravity;
     ...
     * Sets action
     *
     * @param string $action The action name which value is 'hep.gravity.mint.submit'.
     *
     * @return $this
     */
    public function setAction($action)
    {
        if ((mb_strlen($action) > 64)) {
            throw new \InvalidArgumentException('invalid length for $action when calling SubmitMintRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($action) < 1)) {
            throw new \InvalidArgumentException('invalid length for $action when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setUuid($uuid)
    {
        if ((mb_strlen($uuid) > 64)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling SubmitMintRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($uuid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDappId($dapp_id)
    {
        if ((mb_strlen($dapp_id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_id when calling SubmitMintRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_id when calling SubmitMintRequest., must be bigger than or equal to 1.');
        }
