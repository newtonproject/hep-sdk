...
/**
 * HistoryDataRequest Class Doc Comment
 *
 * @category Class
 * @package  HepRestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HistoryDataRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HistoryDataRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['page_id'] < 0)) {
            $invalidProperties[] = "invalid value for 'page_id', must be bigger than or equal to 0.";
        }
    ...
    public function setDappKey($dapp_key)
    {
        if ((mb_strlen($dapp_key) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_key when calling HistoryDataRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_key when calling HistoryDataRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setProtocol($protocol)
    {
        if ((mb_strlen($protocol) > 10)) {
            throw new \InvalidArgumentException('invalid length for $protocol when calling HistoryDataRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($protocol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $protocol when calling HistoryDataRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setVersion($version)
    {
        if ((mb_strlen($version) > 10)) {
            throw new \InvalidArgumentException('invalid length for $version when calling HistoryDataRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($version) < 1)) {
            throw new \InvalidArgumentException('invalid length for $version when calling HistoryDataRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setNonce($nonce)
    {
        if ((mb_strlen($nonce) > 64)) {
            throw new \InvalidArgumentException('invalid length for $nonce when calling HistoryDataRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($nonce) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nonce when calling HistoryDataRequest., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((mb_strlen($os) > 10)) {
            throw new \InvalidArgumentException('invalid length for $os when calling HistoryDataRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($os) < 1)) {
            throw new \InvalidArgumentException('invalid length for $os when calling HistoryDataRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLanguage($language)
    {
        if ((mb_strlen($language) > 10)) {
            throw new \InvalidArgumentException('invalid length for $language when calling HistoryDataRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($language) < 1)) {
            throw new \InvalidArgumentException('invalid length for $language when calling HistoryDataRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDappSignatureMethod($dapp_signature_method)
    {
        if ((mb_strlen($dapp_signature_method) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature_method when calling HistoryDataRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_signature_method) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature_method when calling HistoryDataRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDappSignature($dapp_signature)
    {
        if ((mb_strlen($dapp_signature) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature when calling HistoryDataRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_signature) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature when calling HistoryDataRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setNewid($newid)
    {
        if ((mb_strlen($newid) > 64)) {
            throw new \InvalidArgumentException('invalid length for $newid when calling HistoryDataRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($newid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $newid when calling HistoryDataRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPageId($page_id)
    {
        ...
        if (($page_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_id when calling HistoryDataRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setPageSize($page_size)
    {
        ...
        if (($page_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling HistoryDataRequest., must be bigger than or equal to 1.');
        }
