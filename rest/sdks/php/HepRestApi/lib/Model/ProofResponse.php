...
class ProofResponse implements ModelInterface, ArrayAccess
{
    ...
    public function setDappKey($dapp_key)
    {
        if ((mb_strlen($dapp_key) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_key when calling ProofResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_key when calling ProofResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setProtocol($protocol)
    {
        if ((mb_strlen($protocol) > 10)) {
            throw new \InvalidArgumentException('invalid length for $protocol when calling ProofResponse., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($protocol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $protocol when calling ProofResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setVersion($version)
    {
        if ((mb_strlen($version) > 10)) {
            throw new \InvalidArgumentException('invalid length for $version when calling ProofResponse., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($version) < 1)) {
            throw new \InvalidArgumentException('invalid length for $version when calling ProofResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setNonce($nonce)
    {
        if ((mb_strlen($nonce) > 64)) {
            throw new \InvalidArgumentException('invalid length for $nonce when calling ProofResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($nonce) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nonce when calling ProofResponse., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((mb_strlen($os) > 10)) {
            throw new \InvalidArgumentException('invalid length for $os when calling ProofResponse., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($os) < 1)) {
            throw new \InvalidArgumentException('invalid length for $os when calling ProofResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setLanguage($language)
    {
        if ((mb_strlen($language) > 10)) {
            throw new \InvalidArgumentException('invalid length for $language when calling ProofResponse., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($language) < 1)) {
            throw new \InvalidArgumentException('invalid length for $language when calling ProofResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setDappSignatureMethod($dapp_signature_method)
    {
        if ((mb_strlen($dapp_signature_method) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature_method when calling ProofResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_signature_method) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature_method when calling ProofResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setDappSignature($dapp_signature)
    {
        if ((mb_strlen($dapp_signature) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature when calling ProofResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_signature) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature when calling ProofResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setSignType($sign_type)
    {
        if ((mb_strlen($sign_type) > 64)) {
            throw new \InvalidArgumentException('invalid length for $sign_type when calling ProofResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($sign_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sign_type when calling ProofResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setSignature($signature)
    {
        if ((mb_strlen($signature) > 130)) {
            throw new \InvalidArgumentException('invalid length for $signature when calling ProofResponse., must be smaller than or equal to 130.');
        }
        if ((mb_strlen($signature) < 1)) {
            throw new \InvalidArgumentException('invalid length for $signature when calling ProofResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setAction($action)
    {
        if ((mb_strlen($action) > 64)) {
            throw new \InvalidArgumentException('invalid length for $action when calling ProofResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($action) < 1)) {
            throw new \InvalidArgumentException('invalid length for $action when calling ProofResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setUuid($uuid)
    {
        if ((mb_strlen($uuid) > 64)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling ProofResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($uuid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling ProofResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setDappId($dapp_id)
    {
        if ((mb_strlen($dapp_id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_id when calling ProofResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_id when calling ProofResponse., must be bigger than or equal to 1.');
        }
