...
class NewchainTransactionResponse implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['txid']) > 256)) {
            $invalidProperties[] = "invalid value for 'txid', the character length must be smaller than or equal to 256.";
        }

        if ((mb_strlen($this->container['txid']) < 1)) {
            $invalidProperties[] = "invalid value for 'txid', the character length must be bigger than or equal to 1.";
        }
        ...
        if ((mb_strlen($this->container['from_address']) > 64)) {
            $invalidProperties[] = "invalid value for 'from_address', the character length must be smaller than or equal to 64.";
        }
        ...
        if ((mb_strlen($this->container['to_address']) > 64)) {
            $invalidProperties[] = "invalid value for 'to_address', the character length must be smaller than or equal to 64.";
        }
    ...
    {
        if ((mb_strlen($txid) > 256)) {
            throw new \InvalidArgumentException('invalid length for $txid when calling NewchainTransactionResponse., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($txid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $txid when calling NewchainTransactionResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderNumber($order_number)
    {
        if ((mb_strlen($order_number) > 64)) {
            throw new \InvalidArgumentException('invalid length for $order_number when calling NewchainTransactionResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($order_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $order_number when calling NewchainTransactionResponse., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((mb_strlen($from_address) > 64)) {
            throw new \InvalidArgumentException('invalid length for $from_address when calling NewchainTransactionResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($from_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $from_address when calling NewchainTransactionResponse., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((mb_strlen($to_address) > 64)) {
            throw new \InvalidArgumentException('invalid length for $to_address when calling NewchainTransactionResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($to_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $to_address when calling NewchainTransactionResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setValue($value)
    {
        if ((mb_strlen($value) > 64)) {
            throw new \InvalidArgumentException('invalid length for $value when calling NewchainTransactionResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling NewchainTransactionResponse., must be bigger than or equal to 1.');
        }
