...
/**
 * CreateProofResponse Class Doc Comment
 *
 * @category Class
 * @package  HepRestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateProofResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateProofResponse';
     ...
     * Sets proof_hash
     *
     * @param string $proof_hash The proof hash
     *
     * @return $this
     */
    public function setProofHash($proof_hash)
    {
        if ((mb_strlen($proof_hash) > 64)) {
            throw new \InvalidArgumentException('invalid length for $proof_hash when calling CreateProofResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($proof_hash) < 1)) {
            throw new \InvalidArgumentException('invalid length for $proof_hash when calling CreateProofResponse., must be bigger than or equal to 1.');
        }
