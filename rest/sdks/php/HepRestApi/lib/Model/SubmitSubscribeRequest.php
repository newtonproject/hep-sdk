...
/**
 * SubmitSubscribeRequest Class Doc Comment
 *
 * @category Class
 * @package  HepRestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SubmitSubscribeRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubmitSubscribeRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tx'] === null) {
            $invalidProperties[] = "'tx' can't be null";
        }
        if ((mb_strlen($this->container['tx']) > 256)) {
            $invalidProperties[] = "invalid value for 'tx', the character length must be smaller than or equal to 256.";
        }

        if ((mb_strlen($this->container['tx']) < 1)) {
            $invalidProperties[] = "invalid value for 'tx', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setDappKey($dapp_key)
    {
        if ((mb_strlen($dapp_key) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_key when calling SubmitSubscribeRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_key when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setProtocol($protocol)
    {
        if ((mb_strlen($protocol) > 10)) {
            throw new \InvalidArgumentException('invalid length for $protocol when calling SubmitSubscribeRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($protocol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $protocol when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setVersion($version)
    {
        if ((mb_strlen($version) > 10)) {
            throw new \InvalidArgumentException('invalid length for $version when calling SubmitSubscribeRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($version) < 1)) {
            throw new \InvalidArgumentException('invalid length for $version when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setNonce($nonce)
    {
        if ((mb_strlen($nonce) > 64)) {
            throw new \InvalidArgumentException('invalid length for $nonce when calling SubmitSubscribeRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($nonce) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nonce when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((mb_strlen($os) > 10)) {
            throw new \InvalidArgumentException('invalid length for $os when calling SubmitSubscribeRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($os) < 1)) {
            throw new \InvalidArgumentException('invalid length for $os when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLanguage($language)
    {
        if ((mb_strlen($language) > 10)) {
            throw new \InvalidArgumentException('invalid length for $language when calling SubmitSubscribeRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($language) < 1)) {
            throw new \InvalidArgumentException('invalid length for $language when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDappSignatureMethod($dapp_signature_method)
    {
        if ((mb_strlen($dapp_signature_method) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature_method when calling SubmitSubscribeRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_signature_method) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature_method when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDappSignature($dapp_signature)
    {
        if ((mb_strlen($dapp_signature) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature when calling SubmitSubscribeRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_signature) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSignType($sign_type)
    {
        if ((mb_strlen($sign_type) > 64)) {
            throw new \InvalidArgumentException('invalid length for $sign_type when calling SubmitSubscribeRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($sign_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sign_type when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSignature($signature)
    {
        if ((mb_strlen($signature) > 130)) {
            throw new \InvalidArgumentException('invalid length for $signature when calling SubmitSubscribeRequest., must be smaller than or equal to 130.');
        }
        if ((mb_strlen($signature) < 1)) {
            throw new \InvalidArgumentException('invalid length for $signature when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setNewid($newid)
    {
        if ((mb_strlen($newid) > 64)) {
            throw new \InvalidArgumentException('invalid length for $newid when calling SubmitSubscribeRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($newid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $newid when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((mb_strlen($tx) > 256)) {
            throw new \InvalidArgumentException('invalid length for $tx when calling SubmitSubscribeRequest., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($tx) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tx when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets action
     *
     * @param string $action The action name which value is 'hep.gravity.subscribe'.
     *
     * @return $this
     */
    public function setAction($action)
    {
        if ((mb_strlen($action) > 64)) {
            throw new \InvalidArgumentException('invalid length for $action when calling SubmitSubscribeRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($action) < 1)) {
            throw new \InvalidArgumentException('invalid length for $action when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setUuid($uuid)
    {
        if ((mb_strlen($uuid) > 64)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling SubmitSubscribeRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($uuid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDappId($dapp_id)
    {
        if ((mb_strlen($dapp_id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_id when calling SubmitSubscribeRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_id when calling SubmitSubscribeRequest., must be bigger than or equal to 1.');
        }
