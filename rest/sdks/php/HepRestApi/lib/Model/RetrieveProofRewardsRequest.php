...
/**
 * RetrieveProofRewardsRequest Class Doc Comment
 *
 * @category Class
 * @package  HepRestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RetrieveProofRewardsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RetrieveProofRewardsRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'proof_data' => '\HepRestApi\Model\ProofData[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['proof_data'] = isset($data['proof_data']) ? $data['proof_data'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['proof_data'] === null) {
            $invalidProperties[] = "'proof_data' can't be null";
        }
    ...
    public function setDappKey($dapp_key)
    {
        if ((mb_strlen($dapp_key) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_key when calling RetrieveProofRewardsRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_key when calling RetrieveProofRewardsRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setProtocol($protocol)
    {
        if ((mb_strlen($protocol) > 10)) {
            throw new \InvalidArgumentException('invalid length for $protocol when calling RetrieveProofRewardsRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($protocol) < 1)) {
            throw new \InvalidArgumentException('invalid length for $protocol when calling RetrieveProofRewardsRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setVersion($version)
    {
        if ((mb_strlen($version) > 10)) {
            throw new \InvalidArgumentException('invalid length for $version when calling RetrieveProofRewardsRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($version) < 1)) {
            throw new \InvalidArgumentException('invalid length for $version when calling RetrieveProofRewardsRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setNonce($nonce)
    {
        if ((mb_strlen($nonce) > 64)) {
            throw new \InvalidArgumentException('invalid length for $nonce when calling RetrieveProofRewardsRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($nonce) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nonce when calling RetrieveProofRewardsRequest., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((mb_strlen($os) > 10)) {
            throw new \InvalidArgumentException('invalid length for $os when calling RetrieveProofRewardsRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($os) < 1)) {
            throw new \InvalidArgumentException('invalid length for $os when calling RetrieveProofRewardsRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLanguage($language)
    {
        if ((mb_strlen($language) > 10)) {
            throw new \InvalidArgumentException('invalid length for $language when calling RetrieveProofRewardsRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($language) < 1)) {
            throw new \InvalidArgumentException('invalid length for $language when calling RetrieveProofRewardsRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDappSignatureMethod($dapp_signature_method)
    {
        if ((mb_strlen($dapp_signature_method) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature_method when calling RetrieveProofRewardsRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_signature_method) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature_method when calling RetrieveProofRewardsRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDappSignature($dapp_signature)
    {
        if ((mb_strlen($dapp_signature) > 64)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature when calling RetrieveProofRewardsRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($dapp_signature) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dapp_signature when calling RetrieveProofRewardsRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets proof_data
     *
     * @return \HepRestApi\Model\ProofData[]
     */
    public function getProofData()
    {
        return $this->container['proof_data'];
    }

    /**
     * Sets proof_data
     *
     * @param \HepRestApi\Model\ProofData[] $proof_data The proof data
     *
     * @return $this
     */
    public function setProofData($proof_data)
    {
        $this->container['proof_data'] = $proof_data;
