...
class CollectMintRequest(object):
    ...
    def __init__(self, dapp_key=None, protocol=None, version=None, ts=None, nonce=None, os=None, language=None, dapp_signature_method=None, dapp_signature=None, sign_type=None, signature=None, newid=None, action=None, uuid=None, dapp_id=None):  # noqa: E501
        """CollectMintRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def dapp_key(self):
        """Gets the dapp_key of this CollectMintRequest.  # noqa: E501

        The decentralized application access key  # noqa: E501

        :return: The dapp_key of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def dapp_key(self, dapp_key):
        """Sets the dapp_key of this CollectMintRequest.

        The decentralized application access key  # noqa: E501

        :param dapp_key: The dapp_key of this CollectMintRequest.  # noqa: E501
        :type: str
        """
        if dapp_key is None:
    ...
    @property
    def protocol(self):
        """Gets the protocol of this CollectMintRequest.  # noqa: E501

        The protocol name. default is 'HEP'.  # noqa: E501

        :return: The protocol of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def protocol(self, protocol):
        """Sets the protocol of this CollectMintRequest.

        The protocol name. default is 'HEP'.  # noqa: E501

        :param protocol: The protocol of this CollectMintRequest.  # noqa: E501
        :type: str
        """
        if protocol is None:
    ...
    @property
    def version(self):
        """Gets the version of this CollectMintRequest.  # noqa: E501

        The protocol version such as '1.0'  # noqa: E501

        :return: The version of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this CollectMintRequest.

        The protocol version such as '1.0'  # noqa: E501

        :param version: The version of this CollectMintRequest.  # noqa: E501
        :type: str
        """
        if version is None:
    ...
    @property
    def ts(self):
        """Gets the ts of this CollectMintRequest.  # noqa: E501

        The current timestamp  # noqa: E501

        :return: The ts of this CollectMintRequest.  # noqa: E501
        :rtype: int
        """
        return self._ts
    ...
    @ts.setter
    def ts(self, ts):
        """Sets the ts of this CollectMintRequest.

        The current timestamp  # noqa: E501

        :param ts: The ts of this CollectMintRequest.  # noqa: E501
        :type: int
        """
        if ts is None:
    ...
    @property
    def nonce(self):
        """Gets the nonce of this CollectMintRequest.  # noqa: E501

        The random string or auto-increment sequence  # noqa: E501

        :return: The nonce of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
        return self._nonce
    ...
    def nonce(self, nonce):
        """Sets the nonce of this CollectMintRequest.

        The random string or auto-increment sequence  # noqa: E501

        :param nonce: The nonce of this CollectMintRequest.  # noqa: E501
        :type: str
        """
        if nonce is None:
    ...
    @property
    def os(self):
        """Gets the os of this CollectMintRequest.  # noqa: E501

        The operating system of client such as ios, android, dweb,etc.  # noqa: E501

        :return: The os of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
        return self._os
    ...
    @os.setter
    def os(self, os):
        """Sets the os of this CollectMintRequest.

        The operating system of client such as ios, android, dweb,etc.  # noqa: E501

        :param os: The os of this CollectMintRequest.  # noqa: E501
        :type: str
        """
        if os is None:
    ...
    @property
    def language(self):
        """Gets the language of this CollectMintRequest.  # noqa: E501

        The i18n language code such as zh, en, etc.  # noqa: E501

        :return: The language of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def language(self, language):
        """Sets the language of this CollectMintRequest.

        The i18n language code such as zh, en, etc.  # noqa: E501

        :param language: The language of this CollectMintRequest.  # noqa: E501
        :type: str
        """
        if language is None:
    ...
    def dapp_signature_method(self):
        """Gets the dapp_signature_method of this CollectMintRequest.  # noqa: E501

        The signature method used by dapp.  # noqa: E501

        :return: The dapp_signature_method of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def dapp_signature_method(self, dapp_signature_method):
        """Sets the dapp_signature_method of this CollectMintRequest.

        The signature method used by dapp.  # noqa: E501

        :param dapp_signature_method: The dapp_signature_method of this CollectMintRequest.  # noqa: E501
        :type: str
        """
    ...
    def dapp_signature(self):
        """Gets the dapp_signature of this CollectMintRequest.  # noqa: E501

        The signature generated by dapp.  # noqa: E501

        :return: The dapp_signature of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def dapp_signature(self, dapp_signature):
        """Sets the dapp_signature of this CollectMintRequest.

        The signature generated by dapp.  # noqa: E501

        :param dapp_signature: The dapp_signature of this CollectMintRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def sign_type(self):
        """Gets the sign_type of this CollectMintRequest.  # noqa: E501

        The signature Type,aka cryptographic algorithm.  # noqa: E501

        :return: The sign_type of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def sign_type(self, sign_type):
        """Sets the sign_type of this CollectMintRequest.

        The signature Type,aka cryptographic algorithm.  # noqa: E501

        :param sign_type: The sign_type of this CollectMintRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def signature(self):
        """Gets the signature of this CollectMintRequest.  # noqa: E501

        The signature hex string by application owner. The exclude fields is [sign_type, signature, md5].  # noqa: E501

        :return: The signature of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def signature(self, signature):
        """Sets the signature of this CollectMintRequest.

        The signature hex string by application owner. The exclude fields is [sign_type, signature, md5].  # noqa: E501

        :param signature: The signature of this CollectMintRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def newid(self):
        """Gets the newid of this CollectMintRequest.  # noqa: E501


        :return: The newid of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
        return self._newid
    ...
    def newid(self, newid):
        """Sets the newid of this CollectMintRequest.


        :param newid: The newid of this CollectMintRequest.  # noqa: E501
        :type: str
        """
        if newid is None:
    ...
    @property
    def action(self):
        """Gets the action of this CollectMintRequest.  # noqa: E501

        The action name which value is 'hep.gravity.mint.collect'.  # noqa: E501

        :return: The action of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this CollectMintRequest.

        The action name which value is 'hep.gravity.mint.collect'.  # noqa: E501

        :param action: The action of this CollectMintRequest.  # noqa: E501
        :type: str
        """
        if action is None:
    ...
    @property
    def uuid(self):
        """Gets the uuid of this CollectMintRequest.  # noqa: E501

        The request uuid  # noqa: E501

        :return: The uuid of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
        return self._uuid
    ...
    @uuid.setter
    def uuid(self, uuid):
        """Sets the uuid of this CollectMintRequest.

        The request uuid  # noqa: E501

        :param uuid: The uuid of this CollectMintRequest.  # noqa: E501
        :type: str
        """
        if uuid is None:
    ...
    @property
    def dapp_id(self):
        """Gets the dapp_id of this CollectMintRequest.  # noqa: E501

        The decentralized application ID  # noqa: E501

        :return: The dapp_id of this CollectMintRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def dapp_id(self, dapp_id):
        """Sets the dapp_id of this CollectMintRequest.

        The decentralized application ID  # noqa: E501

        :param dapp_id: The dapp_id of this CollectMintRequest.  # noqa: E501
        :type: str
        """
        if dapp_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CollectMintRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CollectMintRequest):
            return False
