...
class Proof(object):
    ...
    def proof_type(self, proof_type):
        ...
        if proof_type is not None and len(proof_type) > 64:
            raise ValueError("Invalid value for `proof_type`, length must be less than or equal to `64`")  # noqa: E501
        if proof_type is not None and len(proof_type) < 1:
            raise ValueError("Invalid value for `proof_type`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def submitter(self, submitter):
        ...
        if submitter is not None and len(submitter) > 64:
            raise ValueError("Invalid value for `submitter`, length must be less than or equal to `64`")  # noqa: E501
        if submitter is not None and len(submitter) < 1:
            raise ValueError("Invalid value for `submitter`, length must be greater than or equal to `1`")  # noqa: E501
