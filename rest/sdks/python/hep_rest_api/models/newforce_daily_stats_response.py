...
class NewforceDailyStatsResponse(object):
    ...
    def nf_new(self, nf_new):
        ...
        if nf_new is not None and len(nf_new) > 256:
            raise ValueError("Invalid value for `nf_new`, length must be less than or equal to `256`")  # noqa: E501
        if nf_new is not None and len(nf_new) < 1:
            raise ValueError("Invalid value for `nf_new`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def nf_cny(self, nf_cny):
        ...
        if nf_cny is not None and len(nf_cny) > 64:
            raise ValueError("Invalid value for `nf_cny`, length must be less than or equal to `64`")  # noqa: E501
        if nf_cny is not None and len(nf_cny) < 1:
            raise ValueError("Invalid value for `nf_cny`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def nf_usd(self, nf_usd):
        ...
        if nf_usd is not None and len(nf_usd) > 64:
            raise ValueError("Invalid value for `nf_usd`, length must be less than or equal to `64`")  # noqa: E501
        if nf_usd is not None and len(nf_usd) < 1:
            raise ValueError("Invalid value for `nf_usd`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def gnf(self, gnf):
        ...
        if gnf is not None and len(gnf) > 64:
            raise ValueError("Invalid value for `gnf`, length must be less than or equal to `64`")  # noqa: E501
        if gnf is not None and len(gnf) < 1:
            raise ValueError("Invalid value for `gnf`, length must be greater than or equal to `1`")  # noqa: E501
