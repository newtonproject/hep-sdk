...
class Dapp(object):
    ...
    def dapp_name(self, dapp_name):
        ...
        if dapp_name is not None and len(dapp_name) > 64:
            raise ValueError("Invalid value for `dapp_name`, length must be less than or equal to `64`")  # noqa: E501
        if dapp_name is not None and len(dapp_name) < 1:
            raise ValueError("Invalid value for `dapp_name`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def package_name(self, package_name):
        ...
        if package_name is not None and len(package_name) > 64:
            raise ValueError("Invalid value for `package_name`, length must be less than or equal to `64`")  # noqa: E501
    ...
    def bundle_id(self, bundle_id):
        ...
        if bundle_id is not None and len(bundle_id) > 64:
            raise ValueError("Invalid value for `bundle_id`, length must be less than or equal to `64`")  # noqa: E501
        if bundle_id is not None and len(bundle_id) < 1:
            raise ValueError("Invalid value for `bundle_id`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def schema(self, schema):
        ...
        if schema is not None and len(schema) > 64:
            raise ValueError("Invalid value for `schema`, length must be less than or equal to `64`")  # noqa: E501
        if schema is not None and len(schema) < 1:
            raise ValueError("Invalid value for `schema`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def deposit_contract_address(self, deposit_contract_address):
        ...
        if deposit_contract_address is not None and len(deposit_contract_address) > 64:
            raise ValueError("Invalid value for `deposit_contract_address`, length must be less than or equal to `64`")  # noqa: E501
        if deposit_contract_address is not None and len(deposit_contract_address) < 1:
            raise ValueError("Invalid value for `deposit_contract_address`, length must be greater than or equal to `1`")  # noqa: E501
