...
class NewchainTransactionResponse(object):
    ...
    def txid(self, txid):
        ...
        if txid is not None and len(txid) > 256:
            raise ValueError("Invalid value for `txid`, length must be less than or equal to `256`")  # noqa: E501
        if txid is not None and len(txid) < 1:
            raise ValueError("Invalid value for `txid`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def from_address(self, from_address):
        ...
        if from_address is not None and len(from_address) > 64:
            raise ValueError("Invalid value for `from_address`, length must be less than or equal to `64`")  # noqa: E501
    ...
    def to_address(self, to_address):
        ...
        if to_address is not None and len(to_address) > 64:
            raise ValueError("Invalid value for `to_address`, length must be less than or equal to `64`")  # noqa: E501
        if to_address is not None and len(to_address) < 1:
            raise ValueError("Invalid value for `to_address`, length must be greater than or equal to `1`")  # noqa: E501
