...
class CreateAuthCacheResponse(object):
    ...
    def __init__(self, auth_hash=None):  # noqa: E501
        """CreateAuthCacheResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def auth_hash(self, auth_hash):
        ...
        if auth_hash is None:
            raise ValueError("Invalid value for `auth_hash`, must not be `None`")  # noqa: E501
        if auth_hash is not None and len(auth_hash) > 64:
            raise ValueError("Invalid value for `auth_hash`, length must be less than or equal to `64`")  # noqa: E501
        if auth_hash is not None and len(auth_hash) < 1:
            raise ValueError("Invalid value for `auth_hash`, length must be greater than or equal to `1`")  # noqa: E501
