...
class AuthCacheRequest(object):
    ...
    def memo(self, memo):
        ...
        if memo is not None and len(memo) > 64:
            raise ValueError("Invalid value for `memo`, length must be less than or equal to `64`")  # noqa: E501
        if memo is not None and len(memo) < 1:
            raise ValueError("Invalid value for `memo`, length must be greater than or equal to `1`")  # noqa: E501
