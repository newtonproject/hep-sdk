...
class ProofReward(object):
    ...
    def earn_tokens(self, earn_tokens):
        ...
        if earn_tokens is not None and len(earn_tokens) > 64:
            raise ValueError("Invalid value for `earn_tokens`, length must be less than or equal to `64`")  # noqa: E501
        if earn_tokens is not None and len(earn_tokens) < 1:
            raise ValueError("Invalid value for `earn_tokens`, length must be greater than or equal to `1`")  # noqa: E501
