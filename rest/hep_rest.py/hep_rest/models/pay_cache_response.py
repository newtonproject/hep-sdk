...
class PayCacheResponse(object):
    ...
    @property
    def md5(self):
        """Gets the md5 of this PayCacheResponse.  # noqa: E501

        The HMAC authentication md5 checksum  # noqa: E501

        :return: The md5 of this PayCacheResponse.  # noqa: E501
        :rtype: str
        """
        return self._md5
    ...
    @md5.setter
    def md5(self, md5):
        """Sets the md5 of this PayCacheResponse.

        The HMAC authentication md5 checksum  # noqa: E501

        :param md5: The md5 of this PayCacheResponse.  # noqa: E501
        :type: str
        """
        if md5 is None:
